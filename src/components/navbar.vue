...
const searchiconpos= computed(() => 
props.open? "absolute top-1/2 -translate-y-1/2 right-4 text-lg" : "text-lg absolute top-1/2 translate-y-1/2 right-1/2 translate-x-1/2"
)

const navIconspos= computed(() => 
